...
Verifies system configuration, packages, AI models and API keys, environmental variables, shell execution, Ollama availability and CUDA/GPU support.

The diagnostic report is printed directly to the terminal and the process exits after completion.
